...
if FOUND_TORCH is not None:
    ...
    def get_pytorch_gptq_config(n_iter: int,
                                optimizer: Optimizer = Adam([torch.Tensor(1)], lr=1e-4),
                                optimizer_rest: Optimizer = Adam([torch.Tensor(1)], lr=1e-4),
        ...
        Examples:
            ...
            >>> gptq_conf = get_pytorch_gptq_config(n_iter=3, optimizer=torch.optim.NAdam([torch.Tensor(1)]))
